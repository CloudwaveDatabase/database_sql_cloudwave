...
![Go-CloudWave-Driver logo](https://raw.github.com/wiki/go-sql-driver/mysql/gomysql_m.png "Golang Gopher holding the MySQL Dolphin")
...
## Features
  * Lightweight and [fast](https://github.com/go-sql-driver/sql-benchmark "golang CloudWave-Driver performance")
...
## Usage
_Go CloudWave Driver_ is an implementation of Go's `database/sql/driver` interface. You only need to import the driver and can use the full [`database/sql`](https://golang.org/pkg/database/sql/) API then.
...
[Examples are available in our Wiki](https://github.com/go-sql-driver/mysql/wiki/Examples "Go-CloudWave-Driver Examples").
...
See the [godoc of Go-CloudWave-Driver](https://godoc.org/github.com/go-sql-driver/mysql "golang cloudwave driver documentation") for details.
...
### Unicode support
Since version 1.5 Go-CloudWave-Driver automatically uses the collation ` utf8mb4_general_ci` by default.
...
Go-CloudWave-Driver is not feature-complete yet. Your help is very appreciated.
...
## License
Go-CloudWave-Driver is licensed under the [Mozilla Public License Version 2.0](https://raw.github.com/go-sql-driver/mysql/master/LICENSE)
